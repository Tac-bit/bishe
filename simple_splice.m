...
depth2_spliced_info = struct('nodes', depth2_nodes(:, 1), ...
                           ...
                           'spliced_nodes', sort(spliced_depth3_nodes(:)), ...  % 确保是列向量
                           'depth3_nodes', sort(spliced_depth3_nodes(:)));  % 添加深度3节点信息
...
spliced_info = struct('nodes', depth2_nodes(:, 1), ...
                     ...
                     'depth2_spliced_info', depth2_spliced_info, ...
